...
public class DrawDates {
    ...
    public void populateDateOfDraws() {
    ...
    public String getLastFridayOrTuesday(DateTime dateTime) {
        while (dateTime.getDayOfWeek() != DateTimeConstants.FRIDAY && dateTime.getDayOfWeek() != DateTimeConstants.TUESDAY){
            dateTime = dateTime.minusDays(1);
        }
        return formatDateForSwisslos(dateTime.toString(dFormat));
    }
}
